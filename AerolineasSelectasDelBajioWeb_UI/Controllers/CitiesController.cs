...
namespace AerolineasSelectasDelBajioWeb_UI.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(AerolineasSelectasDelBajioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CityId,CityName")] City city)
        {
            ...
            {
                var tempCity = await _context.City.AnyAsync(e => e.CityName == city.CityName);
                if (tempCity)
                {
                    ModelState.AddModelError("CityName", "Ya existe una ciudad con este nombre.");
                    return View(city);
